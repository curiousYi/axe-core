...
function Rule(spec, parentAudit) {
	 ...
	 */
	console.log(
		'selector what about the situation when you don`t have a specific tag?'
	);
	// debugger;
...
Rule.prototype.runChecks = function(
	...
	console.log('running all the checks for each rule');
	// debugger;
...
Rule.prototype.run = function(context, options = {}, resolve, reject) {
	...
	try {
		...
		// debugger;
		console.log('look for node matching');
		//This is the nodes that get checked for the evaluation rules
