...
class Audit {
	 ...
	 */
	_init() {
		//create some default audit object with rules
		...
		/*
			Each rule is the following format;
			        'area-alt': {
	 ...
	 */
	addRule(spec) {
		//add rules here which get done during initialization
		if (spec.metadata) {
